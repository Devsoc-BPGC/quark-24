...
export const CardForEvents = ({ title, description, imageSrc }) => {
  ...
  return (
    ...
    >
      <div
        className={`card border border-gray-300 shadow-md transition-shadow transform ${
      ...
      >
        <div className="overflow-hidden relative flex items-center justify-center">
          <div className="inner-card border border-gray-300 p-4">
            <img className="w-[246px] h-[346px]" src={imageSrc} alt="Event" />
          </div>
          <div
            className={`absolute bottom-2 left-3 p-4 transform ${
              isHovered ? "-translate-y-56" : "translate-y-0"
          ...
          <div
            className={`absolute bottom-0 left-3 p-4 transform ${
              isHovered
          ...
          >
            <p className={`text-white mt-2 font-medium text-xs`}>
              {description}
            </p>
          </div>
          <a href="https://register.bitsquark.in">
            <div
              className={`absolute bottom-0 left-3 p-2 transform ${
                isHovered
