    ...
    >
      <div className={`card border border-gray-300 shadow-md transition-shadow transform ${isHovered ? 'scale-105 opacity-85' : ''}`}>
        <div className="overflow-hidden relative flex items-center justify-center">
          ...
          <div className={`absolute bottom-2 left-3 p-4 transform ${isHovered ? '-translate-y-60' : 'translate-y-0'} transition-transform duration-1000 ease-in-out ${isHovered ? 'hover:shadow-lg' : ''}`}>
          ...
          <a href="https://workshops.hackcloud.co/">
