            ...
            >
                <div className= "flex flex-col md:justify-start mt-20 justify-center ml-5 md:ml-20 ">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <CardForEvents title="ROBORACE" imageSrc={roborace} description="Are you ready to take on the world's best and claim victory? The arena is waiting for you, so lace up your boots and let's play" />
                        <CardForEvents title="ROBOSOCCER" imageSrc={robosoccer} description="Get your team ready and join the ultimate Valorant tournament. Prove your worth, master your aim, and become the champion. Are you up for the challenge?" />
                        <CardForEvents title="THE CHALLENGE" imageSrc={thechallenge} description="Get your team ready and join the ultimate Valorant tournament. Prove your worth, master your aim, and become the champion. Are you up for the challenge?" />
                        <CardForEvents title="ROBOCLENCH" imageSrc={roboclench} description="Get your team ready and join the ultimate Valorant tournament. Prove your worth, master your aim, and become the champion. Are you up for the challenge?" />
                ...
                <div className= "flex flex-col md:justify-start mt-20 justify-center ml-5 md:ml-20">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <CardForEvents title="CASE CRACKDOWN" imageSrc={CaseCrackdown} description="Are you ready to take on the world's best and claim victory? The arena is waiting for you, so lace up your boots and let's play" />
                        <CardForEvents title="POLICY MAVERICK" imageSrc={policy} description="Get your team ready and join the ultimate Valorant tournament. Prove your worth, master your aim, and become the champion. Are you up for the challenge?" />
                ...
                <div className= "flex flex-col md:justify-start mt-20 justify-center ml-5 md:ml-20">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <CardForEvents title="FOOLS CODING" imageSrc={fools_coding} description="Get your team ready and join the ultimate Valorant tournament. Prove your worth, master your aim, and become the champion. Are you up for the challenge?" />
                        <CardForEvents title="HACKATHON" imageSrc={hackathon} description="Are you ready to take on the world's best and claim victory? The arena is waiting for you, so lace up your boots and let's play" />
                        <CardForEvents title="CODEWARS" imageSrc={codewars} description="Are you ready to take on the world's best and claim victory? The arena is waiting for you, so lace up your boots and let's play" />
                ...
                <div className= "flex flex-col md:justify-start mt-20 justify-center ml-5 md:ml-20">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <CardForEvents title="cryptomania" imageSrc={cryptomania} description="Are you ready to take on the world's best and claim victory? The arena is waiting for you, so lace up your boots and let's play" />
                ...
                <div className= "flex md:justify-start mt-20 justify-center ml-5 md:ml-20">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <CardForEvents title="Search and Rescue" imageSrc={search} description="Are you ready to take on the world's best and claim victory? The arena is waiting for you, so lace up your boots and let's play" />
                ...
                <div className= "flex md:justify-start mt-20 justify-center ml-5 md:ml-20">
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <CardForEvents title="Debate" imageSrc={debate} description="Are you ready to take on the world's best and claim victory? The arena is waiting for you, so lace up your boots and let's play" />
